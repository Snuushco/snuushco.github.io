...
export const metadata: Metadata = {
  title: "Aftrekposten-checker | Kassie",
  description: "Gratis Kassie tool voor ZZP'ers. Review-safe, zonder login.",
  alternates: { canonical: "https://kassieapp.nl/tools/aftrekposten-checker" },
};

export default function Page() {
  return (
    <KassieToolShell slug="aftrekposten-checker" title="Aftrekposten-checker" description="Deze toolpagina staat klaar als SEO- en leadmagnet-landingspagina. De interactieve versie volgt achter dezelfde URL zodat indexatie en interne links nu al kunnen starten.">
