...
export const metadata: Metadata = {
  title: "Uurtarief-calculator ZZP | Kassie",
  description: "Gratis Kassie tool voor ZZP'ers. Review-safe, zonder login.",
  alternates: { canonical: "https://kassieapp.nl/tools/uurtarief-calculator" },
};

export default function Page() {
  return (
    <KassieToolShell slug="uurtarief-calculator" title="Uurtarief-calculator ZZP" description="Deze toolpagina staat klaar als SEO- en leadmagnet-landingspagina. De interactieve versie volgt achter dezelfde URL zodat indexatie en interne links nu al kunnen starten.">
