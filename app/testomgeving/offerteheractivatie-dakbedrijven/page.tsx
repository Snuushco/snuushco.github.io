...
const steps = [
  "Upload 3â€“5 geanonimiseerde voorbeelden of een export",
      ...
      <main>
        <section className="hero segment-hero">
          <div className="hero-content">
            <p className="eyebrow">Testpagina â€” niet voor outreach zonder akkoord</p>
        ...
        <section className="band white">
          <div className="inner">
            ...
            <div className="grid three">
              <article className="tile"><h3>Open offertes</h3><p>Na Ã©Ã©n of twee contactmomenten stopt opvolging vaak terwijl de projectwaarde hoog is.</p></article>
          ...
          <div className="inner grid two">
            <article className="tile">
              ...
              <ul>
                ...
                <li>Bij nul bruikbare reacties: Ã©Ã©nmalig 14 dagen verlenging</li>
              </ul>
