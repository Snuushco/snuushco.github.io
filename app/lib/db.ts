    ...
    db.query(
      `
        select
          ...
          count(*) filter (where event_name = 'kassie_tool_view')::int as kassie_tool_view,
          count(*) filter (where event_name = 'kassie_tool_used')::int as kassie_tool_used,
          count(*) filter (where event_name = 'newsletter_signup')::int as newsletter_signup,
          count(*) filter (where event_name = 'contact_click')::int as contact_click,
